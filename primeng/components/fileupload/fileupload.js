...
var FileUpload = /** @class */ (function () {
    ...
    FileUpload = __decorate([
        core_1.Component({
            ...
            template: "<div [ngClass]=\"'ui-fileupload ui-widget'\" [ngStyle]=\"style\" [class]=\"styleClass\" *ngIf=\"mode === 'advanced'\">\n" +
            "  <div class=\"ui-fileupload-buttonbar ui-widget-header ui-corner-top\">\n" +
            "                <span class=\"ui-fileupload-choose\" [label]=\"chooseLabel\" icon=\"fa-plus\" pButton [ngClass]=\"{'ui-state-focus': focus}\">\n" +
            "                    <input #advancedfileinput id=\"uploadFile\" type=\"file\" (change)=\"onFileSelect($event)\" [multiple]=\"multiple\" [accept]=\"accept\" [disabled]=\"disabled\" (focus)=\"onFocus()\" (blur)=\"onBlur()\">\n" +
            "                </span>\n" +
            "\n" +
            ...
            "          <div class=\"text-center\" id=\"add\">+</div>\n" +
            "        </div>\n" +
            "      </div>\n" +
            "      <div *ngIf=\"fileTemplate\">\n" +
